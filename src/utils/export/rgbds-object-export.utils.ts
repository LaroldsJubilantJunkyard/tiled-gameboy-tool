...
SECTION "${executionData.identifier}ObjectsSection", ROM0
...
export const getRGBDSObjectExport = (executionData:ExecutionData):ExportListItem[]=>{
    return [
        {
            contents:getRGBDSObjectExportContents(executionData),
            file: `${executionData.outputDirectory+sep+executionData.identifier}_objects.asm`
        },
    ]
}
