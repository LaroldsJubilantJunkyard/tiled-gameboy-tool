...
world1Area1Tileset: INCBIN "gen/World1Tileset.2bpp"
world1Area1TilesetEnd:
...
WaitVBlank:
	...
	; Copy the tile data
	ld de, world1Area1Tileset
	ld hl, $9000
	ld bc, world1Area1TilesetEnd - world1Area1Tileset
CopyTiles:
	ld a, [de]
	ld [hli], a
	inc de
	...
	; Copy the tile data
	ld de, world1area1_rgbds_Map
	ld hl, $9800
	ld bc, world1area1_rgbds_MapEnd - world1area1_rgbds_Map
CopyTilemap:
	ld a, [de]
	ld [hli], a
	inc de
